...
TEST(Complex8, Load) {
  ...
  {
    const Complex8 complex8(123);

    EXPECT_THAT(complex8.Extract<0>(), ComplexNear(Complex(123, 0), 1e-6f));
    EXPECT_THAT(complex8.Extract<1>(), ComplexNear(Complex(123, 0), 1e-6f));
    EXPECT_THAT(complex8.Extract<2>(), ComplexNear(Complex(123, 0), 1e-6f));
    EXPECT_THAT(complex8.Extract<3>(), ComplexNear(Complex(123, 0), 1e-6f));
    EXPECT_THAT(complex8.Extract<4>(), ComplexNear(Complex(123, 0), 1e-6f));
    EXPECT_THAT(complex8.Extract<5>(), ComplexNear(Complex(123, 0), 1e-6f));
    EXPECT_THAT(complex8.Extract<6>(), ComplexNear(Complex(123, 0), 1e-6f));
    EXPECT_THAT(complex8.Extract<7>(), ComplexNear(Complex(123, 0), 1e-6f));
  }
}
...
TEST(Complex8, FastIntPow) {
  const Complex8 base(Complex(0.0f, 0.0f),
                      Complex(0.1f, 0.2f),
                      Complex(-0.3f, 0.4f),
                      Complex(-0.4f, 0.5f),
                      Complex(0.1f, -0.2f),
                      ...
                      Complex(-0.4f, -0.5f),
                      Complex(0.5f, -0.6f));
  const Complex8 result = FastIntPow(base, 4);
  ...
  EXPECT_THAT(result.Extract<7>(),
              ComplexNear(Complex(-0.3479, 0.132f), 1e-6f));
}
