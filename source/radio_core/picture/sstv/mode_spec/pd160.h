...
// Specification of PD180 SSTV mode.
//
// Color transmission of 512x400 images using YCrCb colorspace.
...
struct ModeSpecInfo<RealType, Mode::kPD160> {
  inline static constexpr Mode kMode{Mode::kPD160};
  ...
  // Image resolution.
  inline static constexpr int kImageWidth{512};
  inline static constexpr int kImageHeight{400};
  ...
  inline static constexpr RealType kPixelDurationInMilliseconds{0.382};
