...
// Specification of PD120 SSTV mode.
//
// Color transmission of 640x496 images using YCrCb colorspace.
...
struct ModeSpecInfo<RealType, Mode::kPD120> {
  inline static constexpr Mode kMode{Mode::kPD120};
  ...
  inline static constexpr int kImageHeight{496};
  ...
  inline static constexpr RealType kPixelDurationInMilliseconds{0.190};
