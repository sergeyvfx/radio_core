...
// Specification of PD90 SSTV mode.
//
// Color transmission of 320x256 images using YCrCb colorspace.
...
struct ModeSpecInfo<RealType, Mode::kPD90> {
  inline static constexpr Mode kMode{Mode::kPD90};
  ...
  // Image resolution.
  inline static constexpr int kImageWidth{320};
  inline static constexpr int kImageHeight{256};
  ...
  inline static constexpr RealType kPixelDurationInMilliseconds{0.532};
